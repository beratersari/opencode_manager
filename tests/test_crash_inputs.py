...
BAD_INBOUND: List[Dict[str, Any]] = [
    ...
    {"label": "null branch", "json": _ok(source_branch=None)},
    {"label": "branch -1", "json": _ok(source_branch="-1")},
    {"label": "branch -1 padded", "json": _ok(source_branch="  -1  ")},
    {"label": "branch empty", "json": _ok(source_branch="")},
    {"label": "branch spaces", "json": _ok(source_branch="   ")},
