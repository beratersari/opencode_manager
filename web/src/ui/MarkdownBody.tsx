...
import { prepareMarkdown } from '../util/chatMarkup'

/** OpenCode sometimes stores the whole body wrapped in extra quotes or \\n. */
...
const components: Components = {
  ...
  table({ children }) {
    return (
      <div className="vd-md-table-wrap">
...
export function MarkdownBody({ text, className = '' }: { text: string; className?: string }) {
  const source = prepareMarkdown(unwrapStoredText(text))
